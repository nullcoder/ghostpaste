...
// .wrangler/tmp/bundle-kDlfYT/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-IZmkWb/bundledWorker-0.1984394210080871.mjs
...
var M = class {
  ...
  applyLocaleRedirects(t) {
    ...
    let { locale: { redirect: s, cookie: n } } = t, i = n && this.cookies[n], a = j(i ?? ""), o = j(this.reqCtx.request.headers.get("accept-language") ?? ""), p = [...a, ...o].map((y) => s[y]).filter(Boolean)[0];
    if (p) {
...
var Ae = /* @__PURE__ */ __name2((...e) => {
  ...
  if (!(r === s && typeof t == "object" && t !== null && s in t)) return Le(...e);
}, "Ae");
...
// .wrangler/tmp/pages-IZmkWb/i3qhnmun4lp.js
...
// .wrangler/tmp/bundle-kDlfYT/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-kDlfYT/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=i3qhnmun4lp.js.map
